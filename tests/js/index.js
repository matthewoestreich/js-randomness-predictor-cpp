...
describe(`V8 : using current environment Node.js '${process.version}'`, () => {
...
describe("V8 : Node.js v24.2.0", () => {
  it("should predict the next random numbers", () => {
    ...
    const expected_v24_2_0 = [0.8664993194151147, 0.5549329443482626, 0.8879559862322086, 0.9570142746667122, 0.7514661363382521, 0.9348208735728415];
