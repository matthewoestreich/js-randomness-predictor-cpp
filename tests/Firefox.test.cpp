...
TEST_CASE("FirefoxPredictor", "[FirefoxPredictor]") {
  SECTION("should correctly predict next random numbers") {
    ...
    std::vector<double> expected{
        0.13963871472821332, 0.25068024611907636, 0.6656237481612675,
        0.7381091878692425,  0.8709382509549467,  0.49171337524788294,
        0.6991749430716799,  0.9530887478758369,  0.781511163650037,
        0.699311162730038,
    };
